...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		btnsiguiente.setToolTipText("Guardar");
	...
	private void headerMousePressed(java.awt.event.MouseEvent evt) {
	    ...
	    private void insertarReserva() {
	        ...
	        Date fechaEntrada = new Date(txtFechaEntrada.getDate().getTime());
	        Date fechaSalida = new Date(txtFechaSalida.getDate().getTime());
	        ...
	        try {
	            ...
	            // Wait for the Exito window to close before continuing
	            exitoFrame.addWindowListener(new WindowAdapter() {
	                @Override
	                public void windowClosed(WindowEvent e) {
	                    ...
	                    // Code to navigate to the next window or perform other actions
	                }
	            });
	        } catch (Exception e) {
	            // Handle exception, display error message, etc.
	            e.printStackTrace();
